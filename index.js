...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5567991720625:+55 67991720625\n' // WhatsApp ID + phone number
            + 'END:VCARD'
/******END OF VCARD INPUT******/
		...
		try {
			...
			mess = {
				...
				only: {
					...
					Badmin: '[❗] O BOT PRECISA SER ADEMAR DO GRUPO MAN❌',
                                        daftarB: `──「 Registre-se 」──\nOla mano !\nVoce não está registrado no banco de dados, \n\nComando : ${prefix}daftar nama|umur\nDigite : .daftar nama|alice ${prefix}`,
				}
			}
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5567991720625@s.whatsapp.net'
                        /******ApiKey Input******/
